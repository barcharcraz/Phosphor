...
proc SetVertexBuffer[T](self: var TDrawObject, vals: openarray[T]) =
  if self.VertexBuffer in ownedBuffers:
    ...
    ownedBuffers.incl(buffer)
proc SetIndexBuffer[T](self: var TDrawObject, vals: openarray[T]) =
  if self.IndexBuffer in ownedBuffers:
...
proc `vertices=`*[T](self: var TDrawObject, verts: openarray[T]) =
  SetVertexBuffer(self, verts)
proc `indices=`*[T](self: var TDrawObject, indices: openarray[T]) =
